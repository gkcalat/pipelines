...
// Describes the state of a PipelineRun.
type PipelineRunState int32

const (
	// The PipelineRun state is unspecified.
	PipelineRunState_PIPELINE_STATE_UNSPECIFIED PipelineRunState = 0
	// The PipelineRun has been created or resumed, and processing has not yet
	// begun.
	PipelineRunState_PIPELINE_STATE_QUEUED PipelineRunState = 1
	// The service is preparing to run the pipeline.
	PipelineRunState_PIPELINE_STATE_PENDING PipelineRunState = 2
	// The PipelineRun is in progress.
	PipelineRunState_PIPELINE_STATE_RUNNING PipelineRunState = 3
	// The PipelineRun completed successfully.
	PipelineRunState_PIPELINE_STATE_SUCCEEDED PipelineRunState = 4
	// The PipelineRun failed.
	PipelineRunState_PIPELINE_STATE_FAILED PipelineRunState = 5
	// The PipelineRun is being cancelled. From this state, the PipelineRun may only go
	// to either PIPELINE_STATE_SUCCEEDED, PIPELINE_STATE_FAILED or
	// PIPELINE_STATE_CANCELLED.
	PipelineRunState_PIPELINE_STATE_CANCELLING PipelineRunState = 6
	// The PipelineRun has been cancelled.
	PipelineRunState_PIPELINE_STATE_CANCELLED PipelineRunState = 7
	// The PipelineRun has been stopped, and can be resumed.
	PipelineRunState_PIPELINE_STATE_PAUSED PipelineRunState = 8
)
...
const (
	...
	// `condition` field of [PipelineRun.pipeline_spec][].
...
func (PipelineTaskDetail_State) EnumDescriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{2, 0}
}
...
func (PipelineTaskSpec_TriggerPolicy_TriggerStrategy) EnumDescriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{14, 1, 0}
}
...
func (PipelineStateEnum_PipelineTaskState) EnumDescriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{29, 0}
}
...
type PipelineRun struct {
	...
	// The resource name of the PipelineRun.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// The display name of the PipelineRun.
	DisplayName string `protobuf:"bytes,2,opt,name=display_name,json=displayName,proto3" json:"display_name,omitempty"`
	// PipelineRun creation time.
	CreateTime *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=create_time,json=createTime,proto3" json:"create_time,omitempty"`
	// PipelineRun start time.
	StartTime *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	// PipelineRun end time.
	EndTime *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	// Timestamp when this PipelineRun was most recently updated.
	...
	// The detailed state of the PipelineRun.
	State PipelineRunState `protobuf:"varint,8,opt,name=state,proto3,enum=ml_pipelines.PipelineRunState" json:"state,omitempty"`
	// The details of PipelineRun.
	RunDetail *PipelineRunDetail `protobuf:"bytes,9,opt,name=run_detail,json=runDetail,proto3" json:"run_detail,omitempty"`
	// The error that occurred during PipelineRun execution.
	// Only populated when the PipelineRun's state is FAILED or CANCELLED.
	Error *status.Status `protobuf:"bytes,10,opt,name=error,proto3" json:"error,omitempty"`
	// The labels with user-defined metadata to organize PipelineRun.
	Labels map[string]string `protobuf:"bytes,11,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Runtime config of the pipeline.
	RuntimeConfig *PipelineRun_RuntimeConfig `protobuf:"bytes,12,opt,name=runtime_config,json=runtimeConfig,proto3" json:"runtime_config,omitempty"`
}
...
func (x *PipelineRun) GetDisplayName() string {
	if x != nil {
...
func (x *PipelineRun) GetPipelineSpec() *structpb.Struct {
	if x != nil {
...
func (x *PipelineRun) GetState() PipelineRunState {
	...
	return PipelineRunState_PIPELINE_STATE_UNSPECIFIED
}

func (x *PipelineRun) GetRunDetail() *PipelineRunDetail {
	if x != nil {
		return x.RunDetail
	}
	return nil
...
func (x *PipelineRun) GetError() *status.Status {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *PipelineRun) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (x *PipelineRun) GetRuntimeConfig() *PipelineRun_RuntimeConfig {
	if x != nil {
...
// The runtime detail of PipelineRun.
type PipelineRunDetail struct {
	...
	// The context of the current PipelineRun.
	...
	// The runtime details of the tasks under the PipelineRun.
...
func (x *PipelineRunDetail) GetPipelineContext() *ml_metadata.Context {
	if x != nil {
...
func (x *PipelineRunDetail) GetPipelineRunContext() *ml_metadata.Context {
	if x != nil {
...
func (x *PipelineRunDetail) GetTaskDetails() []*PipelineTaskDetail {
	if x != nil {
...
type PipelineTaskDetail struct {
	...
	// State of the task.
	State PipelineTaskDetail_State `protobuf:"varint,7,opt,name=state,proto3,enum=ml_pipelines.PipelineTaskDetail_State" json:"state,omitempty"`
...
// The runtime config of a PipelineRun.
type PipelineRun_RuntimeConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Deprecated: Do not use.
	Parameters map[string]*Value `protobuf:"bytes,1,rep,name=parameters,proto3" json:"parameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// The runtime parameters of the PipelineRun. The parameters will be
	// passed into [PipelineRun.pipeline_spec][] to replace the placeholders
	// at runtime.
	ParameterValues map[string]*structpb.Value `protobuf:"bytes,3,rep,name=parameter_values,json=parameterValues,proto3" json:"parameter_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *PipelineRun_RuntimeConfig) Reset() {
	*x = PipelineRun_RuntimeConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *PipelineRun_RuntimeConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PipelineRun_RuntimeConfig) ProtoMessage() {}

func (x *PipelineRun_RuntimeConfig) ProtoReflect() protoreflect.Message {
	mi := &file_pipeline_spec_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PipelineRun_RuntimeConfig.ProtoReflect.Descriptor instead.
func (*PipelineRun_RuntimeConfig) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{0, 1}
}

// Deprecated: Do not use.
func (x *PipelineRun_RuntimeConfig) GetParameters() map[string]*Value {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *PipelineRun_RuntimeConfig) GetParameterValues() map[string]*structpb.Value {
	if x != nil {
		return x.ParameterValues
	}
	return nil
...
type PipelineTaskDetail_PipelineTaskStatus struct {
	...
	State PipelineTaskDetail_State `protobuf:"varint,2,opt,name=state,proto3,enum=ml_pipelines.PipelineTaskDetail_State" json:"state,omitempty"`
...
func (*PipelineTaskDetail_PipelineTaskStatus) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{2, 3}
}
...
type PipelineTaskExecutorDetail_ContainerDetail struct {
	...
	// [PipelineRun.pipeline_spec][] specifies the `pre_caching_check` hook in
...
func (*PipelineTaskExecutorDetail_ContainerDetail) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{3, 0}
}
...
func (*PipelineTaskExecutorDetail_CustomJobDetail) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{3, 1}
}
...
func (*DagOutputsSpec_ParameterSelectorSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{7, 3}
}
...
func (*DagOutputsSpec_ParameterSelectorsSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{7, 4}
}
...
func (*DagOutputsSpec_MapParameterSelectorsSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{7, 5}
}
...
func (*DagOutputsSpec_DagOutputParameterSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{7, 6}
}
...
func (*ComponentOutputsSpec_ParameterSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{9, 1}
}
...
func (*TaskInputsSpec_InputParameterSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{10, 1}
}
...
func (*TaskInputsSpec_InputArtifactSpec_TaskOutputArtifactSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{10, 0, 0}
}
...
func (*TaskInputsSpec_InputParameterSpec_TaskOutputParameterSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{10, 1, 0}
}
...
func (*TaskInputsSpec_InputParameterSpec_TaskFinalStatus) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{10, 1, 1}
}
...
func (*PipelineTaskSpec_TriggerPolicy) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{14, 1}
}
...
func (*PipelineTaskSpec_RetryPolicy) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{14, 2}
}
...
func (*PipelineTaskSpec_IteratorPolicy) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{14, 3}
}
...
func (*PipelineDeploymentConfig_PipelineContainerSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 0}
}
...
func (*PipelineDeploymentConfig_ImporterSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 1}
}
...
func (*PipelineDeploymentConfig_ResolverSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 2}
}
...
func (*PipelineDeploymentConfig_AIPlatformCustomJobSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 3}
}
...
func (*PipelineDeploymentConfig_ExecutorSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 4}
}
...
func (*PipelineDeploymentConfig_PipelineContainerSpec_Lifecycle) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 0, 0}
}
...
func (*PipelineDeploymentConfig_PipelineContainerSpec_ResourceSpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 0, 1}
}
...
func (*PipelineDeploymentConfig_PipelineContainerSpec_EnvVar) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 0, 2}
}
...
func (*PipelineDeploymentConfig_PipelineContainerSpec_Lifecycle_Exec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 0, 0, 0}
}
...
func (*PipelineDeploymentConfig_PipelineContainerSpec_ResourceSpec_AcceleratorConfig) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 0, 1, 0}
}
...
func (*PipelineDeploymentConfig_ResolverSpec_ArtifactQuerySpec) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{22, 2, 0}
}
...
func (*ExecutorInput_OutputParameter) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{26, 1}
}
...
func (x *ExecutorInput_Outputs) Reset() {
	*x = ExecutorInput_Outputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pipeline_spec_proto_msgTypes[100]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExecutorInput_Outputs) Descriptor() ([]byte, []int) {
	return file_pipeline_spec_proto_rawDescGZIP(), []int{26, 2}
}
...
var file_pipeline_spec_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x20, 0x6d, 0x6c, 0x5f,
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	0x61, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe6, 0x08,
	0x0a, 0x0b, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x75, 0x6e, 0x12, 0x12, 0x0a,
	...
	,
	...
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x75, 0x6e, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73,
	...
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c,
	...
	,
	...
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x67, 0x0a, 0x10, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x3c, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73,
	0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x75, 0x6e, 0x2e, 0x52, 0x75, 0x6e,
	...
	0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xe1, 0x01, 0x0a, 0x11, 0x50, 0x69, 0x70, 0x65, 0x6c,
	0x69, 0x6e, 0x65, 0x52, 0x75, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x3f, 0x0a, 0x10,
	...
	,
	...
	0x28, 0x03, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x70, 0x61,
	0x72, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0c, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x49, 0x64,
	0x12, 0x1b, 0x0a, 0x09, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x61, 0x73, 0x6b, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x3b, 0x0a,
	...
	0x61, 0x6d, 0x70, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x51, 0x0a, 0x0f,
	0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x5f, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c,
	0x69, 0x6e, 0x65, 0x73, 0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x73,
	0x6b, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52,
	0x0e, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x72, 0x70, 0x63, 0x2e,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x44, 0x0a,
	0x06, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e,
	0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x50, 0x69, 0x70,
	...
	,
	...
	0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x1a, 0x68, 0x0a, 0x0b, 0x49, 0x6e, 0x70, 0x75,
	0x74, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x43, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69,
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65,
	...
	0x65, 0x73, 0x2e, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x44,
	0x65, 0x74, 0x61, 0x69, 0x6c, 0x2e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x4c, 0x69,
	0x73, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xb9, 0x01,
	...
	0x65, 0x12, 0x3c, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e,
	0x32, 0x26, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e,
	0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x44, 0x65, 0x74, 0x61,
	0x69, 0x6c, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x28, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xa6, 0x01, 0x0a, 0x05, 0x53, 0x74,
	...
	,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x40, 0x0a, 0x0f, 0x64, 0x65, 0x70, 0x6c,
	0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x73, 0x70, 0x65, 0x63, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x17, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x53, 0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x0e, 0x64, 0x65, 0x70, 0x6c,
	0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x70, 0x65, 0x63, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x64,
	0x6b, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0a, 0x73, 0x64, 0x6b, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x25, 0x0a, 0x0e, 0x73,
	...
	,
	...
	0x73, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0c, 0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x5a, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65,
	...
	0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6d, 0x6c, 0x5f, 0x70,
	...
	0x01, 0x22, 0x98, 0x02, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x53,
	0x70, 0x65, 0x63, 0x12, 0x4e, 0x0a, 0x11, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x5f, 0x64, 0x65, 0x66,
	0x69, 0x6e, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21,
	...
	,
	...
	0x12, 0x4c, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x02,
	...
	,
	...
	,
	...
	0x72, 0x4b, 0x65, 0x79, 0x1a, 0x7d, 0x0a, 0x16, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65,
	0x72, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x53, 0x70, 0x65, 0x63, 0x12, 0x63,
	0x0a, 0x13, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x6d, 0x6c,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x73, 0x53, 0x70, 0x65, 0x63, 0x48, 0x00, 0x52, 0x0e, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x46, 0x72, 0x6f, 0x6d, 0x4f, 0x6e, 0x65, 0x6f, 0x66, 0x42, 0x06, 0x0a, 0x04, 0x6b, 0x69, 0x6e,
	0x64, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x1a, 0x72, 0x0a, 0x0f, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x70, 0x75, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63,
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xfa, 0x05, 0x0a, 0x13,
	...
	0x0c, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x54, 0x79, 0x70, 0x65, 0x1a, 0x8a, 0x02,
	0x0a, 0x0d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x12,
	0x45, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d, 0x2e,
	...
	0x74, 0x69, 0x76, 0x65, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x42, 0x02, 0x18, 0x01,
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x54, 0x0a, 0x0e, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65,
	0x74, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2d,
	0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x50, 0x61,
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x2e, 0x50, 0x61, 0x72, 0x61,
	0x6d, 0x65, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x45, 0x6e, 0x75, 0x6d, 0x52, 0x0d, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x3b, 0x0a, 0x0d,
	...
	0x61, 0x75, 0x6c, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x69, 0x73, 0x5f,
	0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a,
	0x69, 0x73, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x1a, 0x6c, 0x0a, 0x0e, 0x41, 0x72,
	...
	0x2e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x53, 0x70, 0x65, 0x63, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x6e, 0x0a, 0x0f, 0x50, 0x61, 0x72, 0x61,
	...
	0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x43, 0x6f, 0x6d, 0x70,
	0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x53, 0x70, 0x65, 0x63, 0x2e,
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x52, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x86, 0x09, 0x0a, 0x14, 0x43, 0x6f, 0x6d,
	0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x53, 0x70, 0x65,
	0x63, 0x12, 0x4f, 0x0a, 0x09, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x18, 0x01,
	...
	0x74, 0x73, 0x12, 0x52, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65,
	...
	,
	...
	0x74, 0x72, 0x79, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74,
	0x69, 0x65, 0x73, 0x12, 0x76, 0x0a, 0x11, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x5f, 0x70, 0x72,
	0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x45,
	0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x43, 0x6f,
	0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x53, 0x70,
	0x65, 0x63, 0x2e, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x53, 0x70, 0x65, 0x63, 0x2e,
	...
	0x1a, 0x64, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	...
	0x6d, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x6a, 0x0a, 0x15, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x38, 0x01, 0x1a, 0xac, 0x01, 0x0a, 0x0d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72,
	0x53, 0x70, 0x65, 0x63, 0x12, 0x45, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	0x6d, 0x42, 0x02, 0x18, 0x01, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x54, 0x0a, 0x0e, 0x70,
	...
	,
	...
	0x72, 0x73, 0x12, 0x49, 0x0a, 0x09, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x18,
	...
	0x72, 0x79, 0x52, 0x09, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x1a, 0xc7, 0x02,
	0x0a, 0x11, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x53,
	0x70, 0x65, 0x63, 0x12, 0x79, 0x0a, 0x14, 0x74, 0x61, 0x73, 0x6b, 0x5f, 0x6f, 0x75, 0x74, 0x70,
	0x75, 0x74, 0x5f, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	,
	...
	0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x54,
	...
	0x74, 0x70, 0x75, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x12, 0x4c, 0x0a,
	0x0d, 0x72, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69,
	0x6e, 0x65, 0x73, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4f, 0x72, 0x52, 0x75, 0x6e, 0x74, 0x69,
	...
	,
	...
	0x70, 0x65, 0x63, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x6c,
	...
	,
	...
	,
	...
	,
	...
	0x32, 0x31, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e,
	...
	0x0b, 0x32, 0x30, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x2e, 0x49, 0x74, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52,
	0x0e, 0x69, 0x74, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a,
	0x33, 0x0a, 0x0e, 0x43, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x63, 0x61, 0x63, 0x68,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x43,
	0x61, 0x63, 0x68, 0x65, 0x1a, 0x80, 0x02, 0x0a, 0x0d, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0xfd, 0x06, 0x0a, 0x15, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x12, 0x64, 0x0a,
	0x09, 0x6c, 0x69, 0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x46, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e,
	...
	0x65, 0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4c,
	0x69, 0x66, 0x65, 0x63, 0x79, 0x63, 0x6c, 0x65, 0x52, 0x09, 0x6c, 0x69, 0x66, 0x65, 0x63, 0x79,
	0x63, 0x6c, 0x65, 0x12, 0x67, 0x0a, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x49, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65,
	...
	0x53, 0x70, 0x65, 0x63, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x70, 0x65,
	0x63, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x12, 0x55, 0x0a, 0x03,
	0x65, 0x6e, 0x76, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x6d, 0x6c, 0x5f, 0x70,
	...
	,
	...
	,
	...
	0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x41, 0x63,
	0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	0x0b, 0x61, 0x63, 0x63, 0x65, 0x6c, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x1a, 0x3d, 0x0a, 0x11,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x32, 0x0a, 0x06, 0x45,
	...
	0xa3, 0x05, 0x0a, 0x0c, 0x49, 0x6d, 0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63,
	0x12, 0x48, 0x0a, 0x0c, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x5f, 0x75, 0x72, 0x69,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65,
	0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x4f, 0x72, 0x52, 0x75, 0x6e,
	0x74, 0x69, 0x6d, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x0b, 0x61,
	0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x55, 0x72, 0x69, 0x12, 0x41, 0x0a, 0x0b, 0x74, 0x79,
	0x70, 0x65, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x61, 0x52, 0x0a, 0x74, 0x79, 0x70, 0x65, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x12, 0x67, 0x0a,
	...
	,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x69, 0x6d, 0x70,
	0x6f, 0x72, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x72, 0x65, 0x69, 0x6d, 0x70,
	0x6f, 0x72, 0x74, 0x1a, 0x64, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x70, 0x65, 0x72, 0x74, 0x69, 0x65,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x6a, 0x0a, 0x15, 0x43, 0x75, 0x73,
	...
	,
	...
	,
	...
	0x43, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x53, 0x70, 0x65, 0x63, 0x48, 0x00, 0x52,
	0x09, 0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x12, 0x51, 0x0a, 0x08, 0x69, 0x6d,
	0x70, 0x6f, 0x72, 0x74, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x6d,
	...
	,
	...
	0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65,
	0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x6f,
	...
	0x75, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x89, 0x04, 0x0a, 0x0f,
	...
	,
	...
	,
	...
	,
	...
	0x78, 0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x70, 0x75, 0x74, 0x2e, 0x4f, 0x75, 0x74,
	0x70, 0x75, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x52, 0x05, 0x76, 0x61,
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x58, 0x0a, 0x0e, 0x41, 0x72, 0x74, 0x69, 0x66,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa4, 0x02, 0x0a, 0x17, 0x50, 0x69,
	0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x54, 0x61, 0x73, 0x6b, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x28, 0x0a, 0x05, 0x65,
	...
	,
	...
	0x10, 0x0d, 0x2a, 0x96, 0x02, 0x0a, 0x10, 0x50, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x52,
	0x75, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1e, 0x0a, 0x1a, 0x50, 0x49, 0x50, 0x45, 0x4c,
	...
	0x54, 0x45, 0x5f, 0x50, 0x41, 0x55, 0x53, 0x45, 0x44, 0x10, 0x08, 0x42, 0x3c, 0x5a, 0x3a, 0x67,
...
var file_pipeline_spec_proto_msgTypes = make([]protoimpl.MessageInfo, 109)
var file_pipeline_spec_proto_goTypes = []interface{}{
	(PipelineRunState)(0),                               // 0: ml_pipelines.PipelineRunState
	(PipelineTaskDetail_State)(0),                       // 1: ml_pipelines.PipelineTaskDetail.State
	(PrimitiveType_PrimitiveTypeEnum)(0),                // 2: ml_pipelines.PrimitiveType.PrimitiveTypeEnum
	(ParameterType_ParameterTypeEnum)(0),                // 3: ml_pipelines.ParameterType.ParameterTypeEnum
	(PipelineTaskSpec_TriggerPolicy_TriggerStrategy)(0), // 4: ml_pipelines.PipelineTaskSpec.TriggerPolicy.TriggerStrategy
	(PipelineStateEnum_PipelineTaskState)(0),            // 5: ml_pipelines.PipelineStateEnum.PipelineTaskState
	(*PipelineRun)(nil),                                 // 6: ml_pipelines.PipelineRun
	(*PipelineRunDetail)(nil),                           // 7: ml_pipelines.PipelineRunDetail
	(*PipelineTaskDetail)(nil),                          // 8: ml_pipelines.PipelineTaskDetail
	(*PipelineTaskExecutorDetail)(nil),                  // 9: ml_pipelines.PipelineTaskExecutorDetail
	(*PipelineSpec)(nil),                                // 10: ml_pipelines.PipelineSpec
	(*ComponentSpec)(nil),                               // 11: ml_pipelines.ComponentSpec
	(*DagSpec)(nil),                                     // 12: ml_pipelines.DagSpec
	(*DagOutputsSpec)(nil),                              // 13: ml_pipelines.DagOutputsSpec
	(*ComponentInputsSpec)(nil),                         // 14: ml_pipelines.ComponentInputsSpec
	(*ComponentOutputsSpec)(nil),                        // 15: ml_pipelines.ComponentOutputsSpec
	(*TaskInputsSpec)(nil),                              // 16: ml_pipelines.TaskInputsSpec
	(*TaskOutputsSpec)(nil),                             // 17: ml_pipelines.TaskOutputsSpec
	(*PrimitiveType)(nil),                               // 18: ml_pipelines.PrimitiveType
	(*ParameterType)(nil),                               // 19: ml_pipelines.ParameterType
	(*PipelineTaskSpec)(nil),                            // 20: ml_pipelines.PipelineTaskSpec
	(*ArtifactIteratorSpec)(nil),                        // 21: ml_pipelines.ArtifactIteratorSpec
	(*ParameterIteratorSpec)(nil),                       // 22: ml_pipelines.ParameterIteratorSpec
	(*ComponentRef)(nil),                                // 23: ml_pipelines.ComponentRef
	(*PipelineInfo)(nil),                                // 24: ml_pipelines.PipelineInfo
	(*ArtifactTypeSchema)(nil),                          // 25: ml_pipelines.ArtifactTypeSchema
	(*PipelineTaskInfo)(nil),                            // 26: ml_pipelines.PipelineTaskInfo
	(*ValueOrRuntimeParameter)(nil),                     // 27: ml_pipelines.ValueOrRuntimeParameter
	(*PipelineDeploymentConfig)(nil),                    // 28: ml_pipelines.PipelineDeploymentConfig
	(*Value)(nil),                                       // 29: ml_pipelines.Value
	(*RuntimeArtifact)(nil),                             // 30: ml_pipelines.RuntimeArtifact
	(*ArtifactList)(nil),                                // 31: ml_pipelines.ArtifactList
	(*ExecutorInput)(nil),                               // 32: ml_pipelines.ExecutorInput
	(*ExecutorOutput)(nil),                              // 33: ml_pipelines.ExecutorOutput
	(*PipelineTaskFinalStatus)(nil),                     // 34: ml_pipelines.PipelineTaskFinalStatus
	(*PipelineStateEnum)(nil),                           // 35: ml_pipelines.PipelineStateEnum
	nil,                                                 // 36: ml_pipelines.PipelineRun.LabelsEntry
	(*PipelineRun_RuntimeConfig)(nil),                   // 37: ml_pipelines.PipelineRun.RuntimeConfig
	nil,                                                 // 38: ml_pipelines.PipelineRun.RuntimeConfig.ParametersEntry
	nil,                                                 // 39: ml_pipelines.PipelineRun.RuntimeConfig.ParameterValuesEntry
	(*PipelineTaskDetail_ArtifactList)(nil),             // 40: ml_pipelines.PipelineTaskDetail.ArtifactList
	nil,                                                 // 41: ml_pipelines.PipelineTaskDetail.InputsEntry
	nil,                                                 // 42: ml_pipelines.PipelineTaskDetail.OutputsEntry
	(*PipelineTaskDetail_PipelineTaskStatus)(nil),       // 43: ml_pipelines.PipelineTaskDetail.PipelineTaskStatus
	(*PipelineTaskExecutorDetail_ContainerDetail)(nil),  // 44: ml_pipelines.PipelineTaskExecutorDetail.ContainerDetail
	(*PipelineTaskExecutorDetail_CustomJobDetail)(nil),  // 45: ml_pipelines.PipelineTaskExecutorDetail.CustomJobDetail
	(*PipelineSpec_RuntimeParameter)(nil),               // 46: ml_pipelines.PipelineSpec.RuntimeParameter
	nil,                                                 // 47: ml_pipelines.PipelineSpec.ComponentsEntry
	nil,                                                 // 48: ml_pipelines.DagSpec.TasksEntry
	(*DagOutputsSpec_ArtifactSelectorSpec)(nil),         // 49: ml_pipelines.DagOutputsSpec.ArtifactSelectorSpec
	(*DagOutputsSpec_DagOutputArtifactSpec)(nil),        // 50: ml_pipelines.DagOutputsSpec.DagOutputArtifactSpec
	nil, // 51: ml_pipelines.DagOutputsSpec.ArtifactsEntry
	(*DagOutputsSpec_ParameterSelectorSpec)(nil),     // 52: ml_pipelines.DagOutputsSpec.ParameterSelectorSpec
	(*DagOutputsSpec_ParameterSelectorsSpec)(nil),    // 53: ml_pipelines.DagOutputsSpec.ParameterSelectorsSpec
	(*DagOutputsSpec_MapParameterSelectorsSpec)(nil), // 54: ml_pipelines.DagOutputsSpec.MapParameterSelectorsSpec
	(*DagOutputsSpec_DagOutputParameterSpec)(nil),    // 55: ml_pipelines.DagOutputsSpec.DagOutputParameterSpec
	nil,                                      // 56: ml_pipelines.DagOutputsSpec.ParametersEntry
	nil,                                      // 57: ml_pipelines.DagOutputsSpec.MapParameterSelectorsSpec.MappedParametersEntry
	(*ComponentInputsSpec_ArtifactSpec)(nil), // 58: ml_pipelines.ComponentInputsSpec.ArtifactSpec
	(*ComponentInputsSpec_ParameterSpec)(nil), // 59: ml_pipelines.ComponentInputsSpec.ParameterSpec
	nil, // 60: ml_pipelines.ComponentInputsSpec.ArtifactsEntry
	nil, // 61: ml_pipelines.ComponentInputsSpec.ParametersEntry
	(*ComponentOutputsSpec_ArtifactSpec)(nil),  // 62: ml_pipelines.ComponentOutputsSpec.ArtifactSpec
	(*ComponentOutputsSpec_ParameterSpec)(nil), // 63: ml_pipelines.ComponentOutputsSpec.ParameterSpec
	nil,                                      // 64: ml_pipelines.ComponentOutputsSpec.ArtifactsEntry
	nil,                                      // 65: ml_pipelines.ComponentOutputsSpec.ParametersEntry
	nil,                                      // 66: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.PropertiesEntry
	nil,                                      // 67: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.CustomPropertiesEntry
	(*TaskInputsSpec_InputArtifactSpec)(nil), // 68: ml_pipelines.TaskInputsSpec.InputArtifactSpec
	(*TaskInputsSpec_InputParameterSpec)(nil), // 69: ml_pipelines.TaskInputsSpec.InputParameterSpec
	nil, // 70: ml_pipelines.TaskInputsSpec.ParametersEntry
	nil, // 71: ml_pipelines.TaskInputsSpec.ArtifactsEntry
	(*TaskInputsSpec_InputArtifactSpec_TaskOutputArtifactSpec)(nil),   // 72: ml_pipelines.TaskInputsSpec.InputArtifactSpec.TaskOutputArtifactSpec
	(*TaskInputsSpec_InputParameterSpec_TaskOutputParameterSpec)(nil), // 73: ml_pipelines.TaskInputsSpec.InputParameterSpec.TaskOutputParameterSpec
	(*TaskInputsSpec_InputParameterSpec_TaskFinalStatus)(nil),         // 74: ml_pipelines.TaskInputsSpec.InputParameterSpec.TaskFinalStatus
	(*TaskOutputsSpec_OutputArtifactSpec)(nil),                        // 75: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec
	(*TaskOutputsSpec_OutputParameterSpec)(nil),                       // 76: ml_pipelines.TaskOutputsSpec.OutputParameterSpec
	nil,                                     // 77: ml_pipelines.TaskOutputsSpec.ParametersEntry
	nil,                                     // 78: ml_pipelines.TaskOutputsSpec.ArtifactsEntry
	nil,                                     // 79: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.PropertiesEntry
	nil,                                     // 80: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.CustomPropertiesEntry
	(*PipelineTaskSpec_CachingOptions)(nil), // 81: ml_pipelines.PipelineTaskSpec.CachingOptions
	(*PipelineTaskSpec_TriggerPolicy)(nil),  // 82: ml_pipelines.PipelineTaskSpec.TriggerPolicy
	(*PipelineTaskSpec_RetryPolicy)(nil),    // 83: ml_pipelines.PipelineTaskSpec.RetryPolicy
	(*PipelineTaskSpec_IteratorPolicy)(nil), // 84: ml_pipelines.PipelineTaskSpec.IteratorPolicy
	(*ArtifactIteratorSpec_ItemsSpec)(nil),  // 85: ml_pipelines.ArtifactIteratorSpec.ItemsSpec
	(*ParameterIteratorSpec_ItemsSpec)(nil), // 86: ml_pipelines.ParameterIteratorSpec.ItemsSpec
	(*PipelineDeploymentConfig_PipelineContainerSpec)(nil),   // 87: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec
	(*PipelineDeploymentConfig_ImporterSpec)(nil),            // 88: ml_pipelines.PipelineDeploymentConfig.ImporterSpec
	(*PipelineDeploymentConfig_ResolverSpec)(nil),            // 89: ml_pipelines.PipelineDeploymentConfig.ResolverSpec
	(*PipelineDeploymentConfig_AIPlatformCustomJobSpec)(nil), // 90: ml_pipelines.PipelineDeploymentConfig.AIPlatformCustomJobSpec
	(*PipelineDeploymentConfig_ExecutorSpec)(nil),            // 91: ml_pipelines.PipelineDeploymentConfig.ExecutorSpec
	nil, // 92: ml_pipelines.PipelineDeploymentConfig.ExecutorsEntry
	(*PipelineDeploymentConfig_PipelineContainerSpec_Lifecycle)(nil),                      // 93: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.Lifecycle
	(*PipelineDeploymentConfig_PipelineContainerSpec_ResourceSpec)(nil),                   // 94: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.ResourceSpec
	(*PipelineDeploymentConfig_PipelineContainerSpec_EnvVar)(nil),                         // 95: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.EnvVar
	(*PipelineDeploymentConfig_PipelineContainerSpec_Lifecycle_Exec)(nil),                 // 96: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.Lifecycle.Exec
	(*PipelineDeploymentConfig_PipelineContainerSpec_ResourceSpec_AcceleratorConfig)(nil), // 97: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.ResourceSpec.AcceleratorConfig
	nil, // 98: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.PropertiesEntry
	nil, // 99: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.CustomPropertiesEntry
	(*PipelineDeploymentConfig_ResolverSpec_ArtifactQuerySpec)(nil), // 100: ml_pipelines.PipelineDeploymentConfig.ResolverSpec.ArtifactQuerySpec
	nil,                                   // 101: ml_pipelines.PipelineDeploymentConfig.ResolverSpec.OutputArtifactQueriesEntry
	nil,                                   // 102: ml_pipelines.RuntimeArtifact.PropertiesEntry
	nil,                                   // 103: ml_pipelines.RuntimeArtifact.CustomPropertiesEntry
	(*ExecutorInput_Inputs)(nil),          // 104: ml_pipelines.ExecutorInput.Inputs
	(*ExecutorInput_OutputParameter)(nil), // 105: ml_pipelines.ExecutorInput.OutputParameter
	(*ExecutorInput_Outputs)(nil),         // 106: ml_pipelines.ExecutorInput.Outputs
	nil,                                   // 107: ml_pipelines.ExecutorInput.Inputs.ParametersEntry
	nil,                                   // 108: ml_pipelines.ExecutorInput.Inputs.ArtifactsEntry
	nil,                                   // 109: ml_pipelines.ExecutorInput.Inputs.ParameterValuesEntry
	nil,                                   // 110: ml_pipelines.ExecutorInput.Outputs.ParametersEntry
	nil,                                   // 111: ml_pipelines.ExecutorInput.Outputs.ArtifactsEntry
	nil,                                   // 112: ml_pipelines.ExecutorOutput.ParametersEntry
	nil,                                   // 113: ml_pipelines.ExecutorOutput.ArtifactsEntry
	nil,                                   // 114: ml_pipelines.ExecutorOutput.ParameterValuesEntry
	...
	(*ml_metadata.Context)(nil),           // 118: ml_metadata.Context
	(*ml_metadata.Execution)(nil),         // 119: ml_metadata.Execution
	(*structpb.Value)(nil),                // 120: google.protobuf.Value
	(*ml_metadata.Artifact)(nil),          // 121: ml_metadata.Artifact
	(*durationpb.Duration)(nil),           // 122: google.protobuf.Duration
}
var file_pipeline_spec_proto_depIdxs = []int32{
	115, // 0: ml_pipelines.PipelineRun.create_time:type_name -> google.protobuf.Timestamp
	115, // 1: ml_pipelines.PipelineRun.start_time:type_name -> google.protobuf.Timestamp
	115, // 2: ml_pipelines.PipelineRun.end_time:type_name -> google.protobuf.Timestamp
	115, // 3: ml_pipelines.PipelineRun.update_time:type_name -> google.protobuf.Timestamp
	116, // 4: ml_pipelines.PipelineRun.pipeline_spec:type_name -> google.protobuf.Struct
	0,   // 5: ml_pipelines.PipelineRun.state:type_name -> ml_pipelines.PipelineRunState
	7,   // 6: ml_pipelines.PipelineRun.run_detail:type_name -> ml_pipelines.PipelineRunDetail
	117, // 7: ml_pipelines.PipelineRun.error:type_name -> google.rpc.Status
	36,  // 8: ml_pipelines.PipelineRun.labels:type_name -> ml_pipelines.PipelineRun.LabelsEntry
	37,  // 9: ml_pipelines.PipelineRun.runtime_config:type_name -> ml_pipelines.PipelineRun.RuntimeConfig
	118, // 10: ml_pipelines.PipelineRunDetail.pipeline_context:type_name -> ml_metadata.Context
	118, // 11: ml_pipelines.PipelineRunDetail.pipeline_run_context:type_name -> ml_metadata.Context
	8,   // 12: ml_pipelines.PipelineRunDetail.task_details:type_name -> ml_pipelines.PipelineTaskDetail
	115, // 13: ml_pipelines.PipelineTaskDetail.create_time:type_name -> google.protobuf.Timestamp
	115, // 14: ml_pipelines.PipelineTaskDetail.start_time:type_name -> google.protobuf.Timestamp
	115, // 15: ml_pipelines.PipelineTaskDetail.end_time:type_name -> google.protobuf.Timestamp
	9,   // 16: ml_pipelines.PipelineTaskDetail.executor_detail:type_name -> ml_pipelines.PipelineTaskExecutorDetail
	1,   // 17: ml_pipelines.PipelineTaskDetail.state:type_name -> ml_pipelines.PipelineTaskDetail.State
	119, // 18: ml_pipelines.PipelineTaskDetail.execution:type_name -> ml_metadata.Execution
	117, // 19: ml_pipelines.PipelineTaskDetail.error:type_name -> google.rpc.Status
	41,  // 20: ml_pipelines.PipelineTaskDetail.inputs:type_name -> ml_pipelines.PipelineTaskDetail.InputsEntry
	42,  // 21: ml_pipelines.PipelineTaskDetail.outputs:type_name -> ml_pipelines.PipelineTaskDetail.OutputsEntry
	43,  // 22: ml_pipelines.PipelineTaskDetail.pipeline_task_status:type_name -> ml_pipelines.PipelineTaskDetail.PipelineTaskStatus
	44,  // 23: ml_pipelines.PipelineTaskExecutorDetail.container_detail:type_name -> ml_pipelines.PipelineTaskExecutorDetail.ContainerDetail
	45,  // 24: ml_pipelines.PipelineTaskExecutorDetail.custom_job_detail:type_name -> ml_pipelines.PipelineTaskExecutorDetail.CustomJobDetail
	24,  // 25: ml_pipelines.PipelineSpec.pipeline_info:type_name -> ml_pipelines.PipelineInfo
	116, // 26: ml_pipelines.PipelineSpec.deployment_spec:type_name -> google.protobuf.Struct
	47,  // 27: ml_pipelines.PipelineSpec.components:type_name -> ml_pipelines.PipelineSpec.ComponentsEntry
	11,  // 28: ml_pipelines.PipelineSpec.root:type_name -> ml_pipelines.ComponentSpec
	14,  // 29: ml_pipelines.ComponentSpec.input_definitions:type_name -> ml_pipelines.ComponentInputsSpec
	15,  // 30: ml_pipelines.ComponentSpec.output_definitions:type_name -> ml_pipelines.ComponentOutputsSpec
	12,  // 31: ml_pipelines.ComponentSpec.dag:type_name -> ml_pipelines.DagSpec
	48,  // 32: ml_pipelines.DagSpec.tasks:type_name -> ml_pipelines.DagSpec.TasksEntry
	13,  // 33: ml_pipelines.DagSpec.outputs:type_name -> ml_pipelines.DagOutputsSpec
	51,  // 34: ml_pipelines.DagOutputsSpec.artifacts:type_name -> ml_pipelines.DagOutputsSpec.ArtifactsEntry
	56,  // 35: ml_pipelines.DagOutputsSpec.parameters:type_name -> ml_pipelines.DagOutputsSpec.ParametersEntry
	60,  // 36: ml_pipelines.ComponentInputsSpec.artifacts:type_name -> ml_pipelines.ComponentInputsSpec.ArtifactsEntry
	61,  // 37: ml_pipelines.ComponentInputsSpec.parameters:type_name -> ml_pipelines.ComponentInputsSpec.ParametersEntry
	64,  // 38: ml_pipelines.ComponentOutputsSpec.artifacts:type_name -> ml_pipelines.ComponentOutputsSpec.ArtifactsEntry
	65,  // 39: ml_pipelines.ComponentOutputsSpec.parameters:type_name -> ml_pipelines.ComponentOutputsSpec.ParametersEntry
	70,  // 40: ml_pipelines.TaskInputsSpec.parameters:type_name -> ml_pipelines.TaskInputsSpec.ParametersEntry
	71,  // 41: ml_pipelines.TaskInputsSpec.artifacts:type_name -> ml_pipelines.TaskInputsSpec.ArtifactsEntry
	77,  // 42: ml_pipelines.TaskOutputsSpec.parameters:type_name -> ml_pipelines.TaskOutputsSpec.ParametersEntry
	78,  // 43: ml_pipelines.TaskOutputsSpec.artifacts:type_name -> ml_pipelines.TaskOutputsSpec.ArtifactsEntry
	26,  // 44: ml_pipelines.PipelineTaskSpec.task_info:type_name -> ml_pipelines.PipelineTaskInfo
	16,  // 45: ml_pipelines.PipelineTaskSpec.inputs:type_name -> ml_pipelines.TaskInputsSpec
	81,  // 46: ml_pipelines.PipelineTaskSpec.caching_options:type_name -> ml_pipelines.PipelineTaskSpec.CachingOptions
	23,  // 47: ml_pipelines.PipelineTaskSpec.component_ref:type_name -> ml_pipelines.ComponentRef
	82,  // 48: ml_pipelines.PipelineTaskSpec.trigger_policy:type_name -> ml_pipelines.PipelineTaskSpec.TriggerPolicy
	21,  // 49: ml_pipelines.PipelineTaskSpec.artifact_iterator:type_name -> ml_pipelines.ArtifactIteratorSpec
	22,  // 50: ml_pipelines.PipelineTaskSpec.parameter_iterator:type_name -> ml_pipelines.ParameterIteratorSpec
	83,  // 51: ml_pipelines.PipelineTaskSpec.retry_policy:type_name -> ml_pipelines.PipelineTaskSpec.RetryPolicy
	84,  // 52: ml_pipelines.PipelineTaskSpec.iterator_policy:type_name -> ml_pipelines.PipelineTaskSpec.IteratorPolicy
	85,  // 53: ml_pipelines.ArtifactIteratorSpec.items:type_name -> ml_pipelines.ArtifactIteratorSpec.ItemsSpec
	86,  // 54: ml_pipelines.ParameterIteratorSpec.items:type_name -> ml_pipelines.ParameterIteratorSpec.ItemsSpec
	29,  // 55: ml_pipelines.ValueOrRuntimeParameter.constant_value:type_name -> ml_pipelines.Value
	120, // 56: ml_pipelines.ValueOrRuntimeParameter.constant:type_name -> google.protobuf.Value
	92,  // 57: ml_pipelines.PipelineDeploymentConfig.executors:type_name -> ml_pipelines.PipelineDeploymentConfig.ExecutorsEntry
	25,  // 58: ml_pipelines.RuntimeArtifact.type:type_name -> ml_pipelines.ArtifactTypeSchema
	102, // 59: ml_pipelines.RuntimeArtifact.properties:type_name -> ml_pipelines.RuntimeArtifact.PropertiesEntry
	103, // 60: ml_pipelines.RuntimeArtifact.custom_properties:type_name -> ml_pipelines.RuntimeArtifact.CustomPropertiesEntry
	116, // 61: ml_pipelines.RuntimeArtifact.metadata:type_name -> google.protobuf.Struct
	30,  // 62: ml_pipelines.ArtifactList.artifacts:type_name -> ml_pipelines.RuntimeArtifact
	104, // 63: ml_pipelines.ExecutorInput.inputs:type_name -> ml_pipelines.ExecutorInput.Inputs
	106, // 64: ml_pipelines.ExecutorInput.outputs:type_name -> ml_pipelines.ExecutorInput.Outputs
	112, // 65: ml_pipelines.ExecutorOutput.parameters:type_name -> ml_pipelines.ExecutorOutput.ParametersEntry
	113, // 66: ml_pipelines.ExecutorOutput.artifacts:type_name -> ml_pipelines.ExecutorOutput.ArtifactsEntry
	114, // 67: ml_pipelines.ExecutorOutput.parameter_values:type_name -> ml_pipelines.ExecutorOutput.ParameterValuesEntry
	117, // 68: ml_pipelines.PipelineTaskFinalStatus.error:type_name -> google.rpc.Status
	38,  // 69: ml_pipelines.PipelineRun.RuntimeConfig.parameters:type_name -> ml_pipelines.PipelineRun.RuntimeConfig.ParametersEntry
	39,  // 70: ml_pipelines.PipelineRun.RuntimeConfig.parameter_values:type_name -> ml_pipelines.PipelineRun.RuntimeConfig.ParameterValuesEntry
	29,  // 71: ml_pipelines.PipelineRun.RuntimeConfig.ParametersEntry.value:type_name -> ml_pipelines.Value
	120, // 72: ml_pipelines.PipelineRun.RuntimeConfig.ParameterValuesEntry.value:type_name -> google.protobuf.Value
	121, // 73: ml_pipelines.PipelineTaskDetail.ArtifactList.artifacts:type_name -> ml_metadata.Artifact
	40,  // 74: ml_pipelines.PipelineTaskDetail.InputsEntry.value:type_name -> ml_pipelines.PipelineTaskDetail.ArtifactList
	40,  // 75: ml_pipelines.PipelineTaskDetail.OutputsEntry.value:type_name -> ml_pipelines.PipelineTaskDetail.ArtifactList
	115, // 76: ml_pipelines.PipelineTaskDetail.PipelineTaskStatus.update_time:type_name -> google.protobuf.Timestamp
	1,   // 77: ml_pipelines.PipelineTaskDetail.PipelineTaskStatus.state:type_name -> ml_pipelines.PipelineTaskDetail.State
	117, // 78: ml_pipelines.PipelineTaskDetail.PipelineTaskStatus.error:type_name -> google.rpc.Status
	2,   // 79: ml_pipelines.PipelineSpec.RuntimeParameter.type:type_name -> ml_pipelines.PrimitiveType.PrimitiveTypeEnum
	29,  // 80: ml_pipelines.PipelineSpec.RuntimeParameter.default_value:type_name -> ml_pipelines.Value
	11,  // 81: ml_pipelines.PipelineSpec.ComponentsEntry.value:type_name -> ml_pipelines.ComponentSpec
	20,  // 82: ml_pipelines.DagSpec.TasksEntry.value:type_name -> ml_pipelines.PipelineTaskSpec
	49,  // 83: ml_pipelines.DagOutputsSpec.DagOutputArtifactSpec.artifact_selectors:type_name -> ml_pipelines.DagOutputsSpec.ArtifactSelectorSpec
	50,  // 84: ml_pipelines.DagOutputsSpec.ArtifactsEntry.value:type_name -> ml_pipelines.DagOutputsSpec.DagOutputArtifactSpec
	52,  // 85: ml_pipelines.DagOutputsSpec.ParameterSelectorsSpec.parameter_selectors:type_name -> ml_pipelines.DagOutputsSpec.ParameterSelectorSpec
	57,  // 86: ml_pipelines.DagOutputsSpec.MapParameterSelectorsSpec.mapped_parameters:type_name -> ml_pipelines.DagOutputsSpec.MapParameterSelectorsSpec.MappedParametersEntry
	52,  // 87: ml_pipelines.DagOutputsSpec.DagOutputParameterSpec.value_from_parameter:type_name -> ml_pipelines.DagOutputsSpec.ParameterSelectorSpec
	53,  // 88: ml_pipelines.DagOutputsSpec.DagOutputParameterSpec.value_from_oneof:type_name -> ml_pipelines.DagOutputsSpec.ParameterSelectorsSpec
	55,  // 89: ml_pipelines.DagOutputsSpec.ParametersEntry.value:type_name -> ml_pipelines.DagOutputsSpec.DagOutputParameterSpec
	52,  // 90: ml_pipelines.DagOutputsSpec.MapParameterSelectorsSpec.MappedParametersEntry.value:type_name -> ml_pipelines.DagOutputsSpec.ParameterSelectorSpec
	25,  // 91: ml_pipelines.ComponentInputsSpec.ArtifactSpec.artifact_type:type_name -> ml_pipelines.ArtifactTypeSchema
	2,   // 92: ml_pipelines.ComponentInputsSpec.ParameterSpec.type:type_name -> ml_pipelines.PrimitiveType.PrimitiveTypeEnum
	3,   // 93: ml_pipelines.ComponentInputsSpec.ParameterSpec.parameter_type:type_name -> ml_pipelines.ParameterType.ParameterTypeEnum
	120, // 94: ml_pipelines.ComponentInputsSpec.ParameterSpec.default_value:type_name -> google.protobuf.Value
	58,  // 95: ml_pipelines.ComponentInputsSpec.ArtifactsEntry.value:type_name -> ml_pipelines.ComponentInputsSpec.ArtifactSpec
	59,  // 96: ml_pipelines.ComponentInputsSpec.ParametersEntry.value:type_name -> ml_pipelines.ComponentInputsSpec.ParameterSpec
	25,  // 97: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.artifact_type:type_name -> ml_pipelines.ArtifactTypeSchema
	66,  // 98: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.properties:type_name -> ml_pipelines.ComponentOutputsSpec.ArtifactSpec.PropertiesEntry
	67,  // 99: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.custom_properties:type_name -> ml_pipelines.ComponentOutputsSpec.ArtifactSpec.CustomPropertiesEntry
	116, // 100: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.metadata:type_name -> google.protobuf.Struct
	2,   // 101: ml_pipelines.ComponentOutputsSpec.ParameterSpec.type:type_name -> ml_pipelines.PrimitiveType.PrimitiveTypeEnum
	3,   // 102: ml_pipelines.ComponentOutputsSpec.ParameterSpec.parameter_type:type_name -> ml_pipelines.ParameterType.ParameterTypeEnum
	62,  // 103: ml_pipelines.ComponentOutputsSpec.ArtifactsEntry.value:type_name -> ml_pipelines.ComponentOutputsSpec.ArtifactSpec
	63,  // 104: ml_pipelines.ComponentOutputsSpec.ParametersEntry.value:type_name -> ml_pipelines.ComponentOutputsSpec.ParameterSpec
	27,  // 105: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.PropertiesEntry.value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	27,  // 106: ml_pipelines.ComponentOutputsSpec.ArtifactSpec.CustomPropertiesEntry.value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	72,  // 107: ml_pipelines.TaskInputsSpec.InputArtifactSpec.task_output_artifact:type_name -> ml_pipelines.TaskInputsSpec.InputArtifactSpec.TaskOutputArtifactSpec
	73,  // 108: ml_pipelines.TaskInputsSpec.InputParameterSpec.task_output_parameter:type_name -> ml_pipelines.TaskInputsSpec.InputParameterSpec.TaskOutputParameterSpec
	27,  // 109: ml_pipelines.TaskInputsSpec.InputParameterSpec.runtime_value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	74,  // 110: ml_pipelines.TaskInputsSpec.InputParameterSpec.task_final_status:type_name -> ml_pipelines.TaskInputsSpec.InputParameterSpec.TaskFinalStatus
	69,  // 111: ml_pipelines.TaskInputsSpec.ParametersEntry.value:type_name -> ml_pipelines.TaskInputsSpec.InputParameterSpec
	68,  // 112: ml_pipelines.TaskInputsSpec.ArtifactsEntry.value:type_name -> ml_pipelines.TaskInputsSpec.InputArtifactSpec
	25,  // 113: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.artifact_type:type_name -> ml_pipelines.ArtifactTypeSchema
	79,  // 114: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.properties:type_name -> ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.PropertiesEntry
	80,  // 115: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.custom_properties:type_name -> ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.CustomPropertiesEntry
	2,   // 116: ml_pipelines.TaskOutputsSpec.OutputParameterSpec.type:type_name -> ml_pipelines.PrimitiveType.PrimitiveTypeEnum
	76,  // 117: ml_pipelines.TaskOutputsSpec.ParametersEntry.value:type_name -> ml_pipelines.TaskOutputsSpec.OutputParameterSpec
	75,  // 118: ml_pipelines.TaskOutputsSpec.ArtifactsEntry.value:type_name -> ml_pipelines.TaskOutputsSpec.OutputArtifactSpec
	27,  // 119: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.PropertiesEntry.value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	27,  // 120: ml_pipelines.TaskOutputsSpec.OutputArtifactSpec.CustomPropertiesEntry.value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	4,   // 121: ml_pipelines.PipelineTaskSpec.TriggerPolicy.strategy:type_name -> ml_pipelines.PipelineTaskSpec.TriggerPolicy.TriggerStrategy
	122, // 122: ml_pipelines.PipelineTaskSpec.RetryPolicy.backoff_duration:type_name -> google.protobuf.Duration
	122, // 123: ml_pipelines.PipelineTaskSpec.RetryPolicy.backoff_max_duration:type_name -> google.protobuf.Duration
	93,  // 124: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.lifecycle:type_name -> ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.Lifecycle
	94,  // 125: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.resources:type_name -> ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.ResourceSpec
	95,  // 126: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.env:type_name -> ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.EnvVar
	27,  // 127: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.artifact_uri:type_name -> ml_pipelines.ValueOrRuntimeParameter
	25,  // 128: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.type_schema:type_name -> ml_pipelines.ArtifactTypeSchema
	98,  // 129: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.properties:type_name -> ml_pipelines.PipelineDeploymentConfig.ImporterSpec.PropertiesEntry
	99,  // 130: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.custom_properties:type_name -> ml_pipelines.PipelineDeploymentConfig.ImporterSpec.CustomPropertiesEntry
	116, // 131: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.metadata:type_name -> google.protobuf.Struct
	101, // 132: ml_pipelines.PipelineDeploymentConfig.ResolverSpec.output_artifact_queries:type_name -> ml_pipelines.PipelineDeploymentConfig.ResolverSpec.OutputArtifactQueriesEntry
	116, // 133: ml_pipelines.PipelineDeploymentConfig.AIPlatformCustomJobSpec.custom_job:type_name -> google.protobuf.Struct
	87,  // 134: ml_pipelines.PipelineDeploymentConfig.ExecutorSpec.container:type_name -> ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec
	88,  // 135: ml_pipelines.PipelineDeploymentConfig.ExecutorSpec.importer:type_name -> ml_pipelines.PipelineDeploymentConfig.ImporterSpec
	89,  // 136: ml_pipelines.PipelineDeploymentConfig.ExecutorSpec.resolver:type_name -> ml_pipelines.PipelineDeploymentConfig.ResolverSpec
	90,  // 137: ml_pipelines.PipelineDeploymentConfig.ExecutorSpec.custom_job:type_name -> ml_pipelines.PipelineDeploymentConfig.AIPlatformCustomJobSpec
	91,  // 138: ml_pipelines.PipelineDeploymentConfig.ExecutorsEntry.value:type_name -> ml_pipelines.PipelineDeploymentConfig.ExecutorSpec
	96,  // 139: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.Lifecycle.pre_cache_check:type_name -> ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.Lifecycle.Exec
	97,  // 140: ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.ResourceSpec.accelerator:type_name -> ml_pipelines.PipelineDeploymentConfig.PipelineContainerSpec.ResourceSpec.AcceleratorConfig
	27,  // 141: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.PropertiesEntry.value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	27,  // 142: ml_pipelines.PipelineDeploymentConfig.ImporterSpec.CustomPropertiesEntry.value:type_name -> ml_pipelines.ValueOrRuntimeParameter
	100, // 143: ml_pipelines.PipelineDeploymentConfig.ResolverSpec.OutputArtifactQueriesEntry.value:type_name -> ml_pipelines.PipelineDeploymentConfig.ResolverSpec.ArtifactQuerySpec
	29,  // 144: ml_pipelines.RuntimeArtifact.PropertiesEntry.value:type_name -> ml_pipelines.Value
	29,  // 145: ml_pipelines.RuntimeArtifact.CustomPropertiesEntry.value:type_name -> ml_pipelines.Value
	107, // 146: ml_pipelines.ExecutorInput.Inputs.parameters:type_name -> ml_pipelines.ExecutorInput.Inputs.ParametersEntry
	108, // 147: ml_pipelines.ExecutorInput.Inputs.artifacts:type_name -> ml_pipelines.ExecutorInput.Inputs.ArtifactsEntry
	109, // 148: ml_pipelines.ExecutorInput.Inputs.parameter_values:type_name -> ml_pipelines.ExecutorInput.Inputs.ParameterValuesEntry
	110, // 149: ml_pipelines.ExecutorInput.Outputs.parameters:type_name -> ml_pipelines.ExecutorInput.Outputs.ParametersEntry
	111, // 150: ml_pipelines.ExecutorInput.Outputs.artifacts:type_name -> ml_pipelines.ExecutorInput.Outputs.ArtifactsEntry
	29,  // 151: ml_pipelines.ExecutorInput.Inputs.ParametersEntry.value:type_name -> ml_pipelines.Value
	31,  // 152: ml_pipelines.ExecutorInput.Inputs.ArtifactsEntry.value:type_name -> ml_pipelines.ArtifactList
	120, // 153: ml_pipelines.ExecutorInput.Inputs.ParameterValuesEntry.value:type_name -> google.protobuf.Value
	105, // 154: ml_pipelines.ExecutorInput.Outputs.ParametersEntry.value:type_name -> ml_pipelines.ExecutorInput.OutputParameter
	31,  // 155: ml_pipelines.ExecutorInput.Outputs.ArtifactsEntry.value:type_name -> ml_pipelines.ArtifactList
	29,  // 156: ml_pipelines.ExecutorOutput.ParametersEntry.value:type_name -> ml_pipelines.Value
	31,  // 157: ml_pipelines.ExecutorOutput.ArtifactsEntry.value:type_name -> ml_pipelines.ArtifactList
	120, // 158: ml_pipelines.ExecutorOutput.ParameterValuesEntry.value:type_name -> google.protobuf.Value
...
func file_pipeline_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pipeline_spec_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PipelineRunDetail); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pipeline_spec_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PipelineRun_RuntimeConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pipeline_spec_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[81].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[90].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[91].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[98].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[99].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pipeline_spec_proto_msgTypes[100].Exporter = func(v interface{}, i int) interface{} {
	...
	file_pipeline_spec_proto_msgTypes[23].OneofWrappers = []interface{}{
		(*Value_IntValue)(nil),
	...
	file_pipeline_spec_proto_msgTypes[62].OneofWrappers = []interface{}{
		(*TaskInputsSpec_InputArtifactSpec_TaskOutputArtifact)(nil),
		(*TaskInputsSpec_InputArtifactSpec_ComponentInputArtifact)(nil),
	}
	file_pipeline_spec_proto_msgTypes[63].OneofWrappers = []interface{}{
	...
	file_pipeline_spec_proto_msgTypes[85].OneofWrappers = []interface{}{
