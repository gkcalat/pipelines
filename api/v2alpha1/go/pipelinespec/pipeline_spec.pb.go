...
const (
	...
	RunState_RUN_STATE_PENDING RunState = 2
	// The Run is in progress.
	RunState_RUN_STATE_RUNNING RunState = 3
	// The Run completed successfully.
	RunState_RUN_STATE_SUCCEEDED RunState = 4
	// The Run failed.
	RunState_RUN_STATE_FAILED RunState = 5
	// The Run is being cancelled. From this state, the Run may only go
	// to either RUN_STATE_SUCCEEDED, RUN_STATE_FAILED or
	// RUN_STATE_CANCELLED.
	RunState_RUN_STATE_CANCELLING RunState = 6
	// The Run has been cancelled.
	RunState_RUN_STATE_CANCELLED RunState = 7
	// The Run has been stopped, and can be resumed.
	RunState_RUN_STATE_PAUSED RunState = 8
)
...
type Run struct {
	...
	// Timestamp when this Run was most recently updated.
	...
	// The detailed state of the Run.
	State RunState `protobuf:"varint,8,opt,name=state,proto3,enum=ml_pipelines.RunState" json:"state,omitempty"`
	// The details of Run.
	RunDetail *RunDetail `protobuf:"bytes,9,opt,name=run_detail,json=runDetail,proto3" json:"run_detail,omitempty"`
	...
	// The labels with user-defined metadata to organize Run.
	Labels map[string]string `protobuf:"bytes,11,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// Runtime config of the pipeline.
	RuntimeConfig *Run_RuntimeConfig `protobuf:"bytes,12,opt,name=runtime_config,json=runtimeConfig,proto3" json:"runtime_config,omitempty"`
}
...
type PipelineTaskFinalStatus struct {
	...
	// The pipeline job name from the [Run.name][].
	//
	// Deprecated: Do not use.
...
type Run_RuntimeConfig struct {
	...
	// Deprecated: Do not use.
	Parameters map[string]*Value `protobuf:"bytes,1,rep,name=parameters,proto3" json:"parameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// The runtime parameters of the Run. The parameters will be
	// passed into [Run.pipeline_spec][] to replace the placeholders
	// at runtime.
	ParameterValues map[string]*structpb.Value `protobuf:"bytes,3,rep,name=parameter_values,json=parameterValues,proto3" json:"parameter_values,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
// Deprecated: Do not use.
func (x *Run_RuntimeConfig) GetParameters() map[string]*Value {
	if x != nil {
		return x.Parameters
	}
	return nil
...
func (x *Run_RuntimeConfig) GetParameterValues() map[string]*structpb.Value {
	if x != nil {
		return x.ParameterValues
	}
	return nil
...
var file_pipeline_spec_proto_rawDesc = []byte{
	...
	0x61, 0x5f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xae, 0x08,
	0x0a, 0x03, 0x52, 0x75, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	...
	,
	...
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c,
	0x69, 0x6e, 0x65, 0x73, 0x2e, 0x52, 0x75, 0x6e, 0x2e, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65,
	...
	0x1a, 0xfb, 0x02, 0x0a, 0x0d, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x12, 0x53, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65,
	0x6c, 0x69, 0x6e, 0x65, 0x73, 0x2e, 0x52, 0x75, 0x6e, 0x2e, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d,
	...
	0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x12, 0x5f, 0x0a, 0x10, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x65, 0x74, 0x65, 0x72, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x34, 0x2e, 0x6d, 0x6c, 0x5f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x73,
	0x2e, 0x52, 0x75, 0x6e, 0x2e, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x65, 0x72, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x1a, 0x52, 0x0a, 0x0f, 0x50, 0x61, 0x72, 0x61,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0xd9,
	0x01, 0x0a, 0x09, 0x52, 0x75, 0x6e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x3f, 0x0a, 0x10,
	...
	,
	...
	0x70, 0x68, 0x61, 0x31, 0x2f, 0x67, 0x6f, 0x2f, 0x70, 0x69, 0x70, 0x65, 0x6c, 0x69, 0x6e, 0x65,
...
var file_pipeline_spec_proto_goTypes = []interface{}{
	(RunState)(0),                                       // 0: ml_pipelines.RunState
	...
	(*Run)(nil),                                         // 6: ml_pipelines.Run
	(*RunDetail)(nil),                                   // 7: ml_pipelines.RunDetail
	...
	nil,                                                 // 36: ml_pipelines.Run.LabelsEntry
	(*Run_RuntimeConfig)(nil),                           // 37: ml_pipelines.Run.RuntimeConfig
	nil,                                                 // 38: ml_pipelines.Run.RuntimeConfig.ParametersEntry
	nil,                                                 // 39: ml_pipelines.Run.RuntimeConfig.ParameterValuesEntry
...
var file_pipeline_spec_proto_depIdxs = []int32{
	115, // 0: ml_pipelines.Run.create_time:type_name -> google.protobuf.Timestamp
	115, // 1: ml_pipelines.Run.start_time:type_name -> google.protobuf.Timestamp
	115, // 2: ml_pipelines.Run.end_time:type_name -> google.protobuf.Timestamp
	115, // 3: ml_pipelines.Run.update_time:type_name -> google.protobuf.Timestamp
	116, // 4: ml_pipelines.Run.pipeline_spec:type_name -> google.protobuf.Struct
	0,   // 5: ml_pipelines.Run.state:type_name -> ml_pipelines.RunState
	7,   // 6: ml_pipelines.Run.run_detail:type_name -> ml_pipelines.RunDetail
	117, // 7: ml_pipelines.Run.error:type_name -> google.rpc.Status
	36,  // 8: ml_pipelines.Run.labels:type_name -> ml_pipelines.Run.LabelsEntry
	37,  // 9: ml_pipelines.Run.runtime_config:type_name -> ml_pipelines.Run.RuntimeConfig
	118, // 10: ml_pipelines.RunDetail.pipeline_context:type_name -> ml_metadata.Context
	118, // 11: ml_pipelines.RunDetail.pipeline_run_context:type_name -> ml_metadata.Context
	8,   // 12: ml_pipelines.RunDetail.task_details:type_name -> ml_pipelines.PipelineTaskDetail
	...
	38,  // 69: ml_pipelines.Run.RuntimeConfig.parameters:type_name -> ml_pipelines.Run.RuntimeConfig.ParametersEntry
	39,  // 70: ml_pipelines.Run.RuntimeConfig.parameter_values:type_name -> ml_pipelines.Run.RuntimeConfig.ParameterValuesEntry
	29,  // 71: ml_pipelines.Run.RuntimeConfig.ParametersEntry.value:type_name -> ml_pipelines.Value
	120, // 72: ml_pipelines.Run.RuntimeConfig.ParameterValuesEntry.value:type_name -> google.protobuf.Value
