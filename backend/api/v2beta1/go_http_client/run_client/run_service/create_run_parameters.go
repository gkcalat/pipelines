...
// WithRunExperimentID adds the runExperimentID to the create run params
func (o *CreateRunParams) WithRunExperimentID(runExperimentID string) *CreateRunParams {
	o.SetRunExperimentID(runExperimentID)
	return o
}

// SetRunExperimentID adds the runExperimentId to the create run params
func (o *CreateRunParams) SetRunExperimentID(runExperimentID string) {
	o.RunExperimentID = runExperimentID
}
...
func (o *CreateRunParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param run.experiment_id
	if err := r.SetPathParam("run.experiment_id", o.RunExperimentID); err != nil {
		return err
	}
