...
/*
CreateRun creates a new run in the experiment specified by the experiment ID if experiment ID is not specified the run is created in the default experiment
*/
func (a *Client) CreateRun(params *CreateRunParams, authInfo runtime.ClientAuthInfoWriter) (*CreateRunOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "CreateRun",
		Method:             "POST",
		PathPattern:        "/apis/v2beta1/experiments/{run.experiment_id}/runs",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
/*
ListRuns finds all runs in an experiment given experiment id finds all runs across all experiments if experiment id is not specified
*/
