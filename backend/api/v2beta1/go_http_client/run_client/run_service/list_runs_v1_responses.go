...
func (o *ListRunsV1OK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/runs][%d] listRunsV1OK  %+v", 200, o.Payload)
}
...
func (o *ListRunsV1Default) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/runs][%d] ListRunsV1 default  %+v", o._statusCode, o.Payload)
}
