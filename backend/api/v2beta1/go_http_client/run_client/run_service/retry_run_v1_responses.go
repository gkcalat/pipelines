...
func (o *RetryRunV1OK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/runs/{run_id}/retry][%d] retryRunV1OK  %+v", 200, o.Payload)
}
...
func (o *RetryRunV1Default) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/runs/{run_id}/retry][%d] RetryRunV1 default  %+v", o._statusCode, o.Payload)
}
