...
// APIRecurringRun api recurring run
// swagger:model apiRecurringRun
type APIRecurringRun struct {
	...
	// status
	Status APIRecurringRunStatus `json:"status,omitempty"`
...
// Validate validates this api recurring run
func (m *APIRecurringRun) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIRecurringRun) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *APIRecurringRun) validateMode(formats strfmt.Registry) error {
...
func (m *APIRecurringRun) validateRuntimeConfig(formats strfmt.Registry) error {
...
func (m *APIRecurringRun) validateStatus(formats strfmt.Registry) error {
...
func (m *APIRecurringRun) validateTrigger(formats strfmt.Registry) error {
...
func (m *APIRecurringRun) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *APIRecurringRun) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *APIRecurringRun) UnmarshalBinary(b []byte) error {
	var res APIRecurringRun
