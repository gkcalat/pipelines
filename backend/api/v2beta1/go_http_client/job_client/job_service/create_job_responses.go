...
func (o *CreateJobOK) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/jobs][%d] createJobOK  %+v", 200, o.Payload)
}
...
func (o *CreateJobDefault) Error() string {
	return fmt.Sprintf("[POST /apis/v2beta1/jobs][%d] CreateJob default  %+v", o._statusCode, o.Payload)
}
