...
func (o *ListPipelineVersionsV1OK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipeline_versions][%d] listPipelineVersionsV1OK  %+v", 200, o.Payload)
}
...
func (o *ListPipelineVersionsV1Default) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipeline_versions][%d] ListPipelineVersionsV1 default  %+v", o._statusCode, o.Payload)
}
