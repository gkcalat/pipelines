...
func (o *GetPipelineV1OK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{id}][%d] getPipelineV1OK  %+v", 200, o.Payload)
}
...
func (o *GetPipelineV1Default) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/pipelines/{id}][%d] GetPipelineV1 default  %+v", o._statusCode, o.Payload)
}
