...
func (o *GetPipelineByNameV1OK) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/namespaces/{namespace}/pipelines/{name}][%d] getPipelineByNameV1OK  %+v", 200, o.Payload)
}
...
func (o *GetPipelineByNameV1Default) Error() string {
	return fmt.Sprintf("[GET /apis/v2beta1/namespaces/{namespace}/pipelines/{name}][%d] GetPipelineByNameV1 default  %+v", o._statusCode, o.Payload)
}
