...
class ApiPipelineTaskExecutorDetail(object):
    ...
    def __init__(self, main_job=None, pre_caching_check_job=None, failed_main_jobs=None, failed_pre_caching_check_jobs=None, local_vars_configuration=None):  # noqa: E501
        """ApiPipelineTaskExecutorDetail - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def main_job(self):
        """Gets the main_job of this ApiPipelineTaskExecutorDetail.  # noqa: E501

        The name of the job for the main container execution.  # noqa: E501

        :return: The main_job of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def main_job(self, main_job):
        """Sets the main_job of this ApiPipelineTaskExecutorDetail.

        The name of the job for the main container execution.  # noqa: E501

        :param main_job: The main_job of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        :type main_job: str
        """
    ...
    def pre_caching_check_job(self):
        """Gets the pre_caching_check_job of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        ...
        :return: The pre_caching_check_job of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        :rtype: str
        """
    ...
    def pre_caching_check_job(self, pre_caching_check_job):
        """Sets the pre_caching_check_job of this ApiPipelineTaskExecutorDetail.

        The name of the job for the pre-caching-check container execution. This job will be available if the Run.pipeline_spec specifies the `pre_caching_check` hook in the lifecycle events.  # noqa: E501

        :param pre_caching_check_job: The pre_caching_check_job of this ApiPipelineTaskExecutorDetail.  # noqa: E501
    ...
    def failed_main_jobs(self):
        """Gets the failed_main_jobs of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        ...
        :return: The failed_main_jobs of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def failed_main_jobs(self, failed_main_jobs):
        """Sets the failed_main_jobs of this ApiPipelineTaskExecutorDetail.

        The names of the previously failed job for the main container executions. The list includes the all attempts in chronological order.  # noqa: E501

        :param failed_main_jobs: The failed_main_jobs of this ApiPipelineTaskExecutorDetail.  # noqa: E501
    ...
    def failed_pre_caching_check_jobs(self):
        """Gets the failed_pre_caching_check_jobs of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        ...
        :return: The failed_pre_caching_check_jobs of this ApiPipelineTaskExecutorDetail.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def failed_pre_caching_check_jobs(self, failed_pre_caching_check_jobs):
        """Sets the failed_pre_caching_check_jobs of this ApiPipelineTaskExecutorDetail.

        The names of the previously failed job for the pre-caching-check container executions. This job will be available if the Run.pipeline_spec specifies the `pre_caching_check` hook in the lifecycle events. The list includes the all attempts in chronological order.  # noqa: E501

        :param failed_pre_caching_check_jobs: The failed_pre_caching_check_jobs of this ApiPipelineTaskExecutorDetail.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApiPipelineTaskExecutorDetail):
            return False
