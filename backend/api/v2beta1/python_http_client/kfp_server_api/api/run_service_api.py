...
class RunServiceApi(object):
    ...
    def create_run(self, run_experiment_id, body, **kwargs):  # noqa: E501
        """Creates a new run in the experiment specified by the experiment ID. If experiment ID is not specified, the run is created in the default experiment.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_run(run_experiment_id, body, async_req=True)
        >>> result = thread.get()

        :param run_experiment_id: Id of the experiment this run belongs to. (required)
        :type run_experiment_id: str
        :param body: (required)
        :type body: ApiRun
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.create_run_with_http_info(run_experiment_id, body, **kwargs)  # noqa: E501

    def create_run_with_http_info(self, run_experiment_id, body, **kwargs):  # noqa: E501
        """Creates a new run in the experiment specified by the experiment ID. If experiment ID is not specified, the run is created in the default experiment.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_run_with_http_info(run_experiment_id, body, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiRun, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'run_experiment_id' is set
        if self.api_client.client_side_validation and ('run_experiment_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['run_experiment_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `run_experiment_id` when calling `create_run`")  # noqa: E501
        ...
        path_params = {}
        if 'run_experiment_id' in local_var_params:
            path_params['run.experiment_id'] = local_var_params['run_experiment_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/experiments/{run.experiment_id}/runs', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiRun',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_runs(self, **kwargs):  # noqa: E501
        """Find all runs in an experiment given experiment id. Finds all runs across all experiments if experiment id is not specified.  # noqa: E501
        ...
        :type filter: str
        :param experiment_id: The ID of the experiment to be retrieved. If empty, list runs across all experiments.
    ...
    def report_run_metrics_with_http_info(self, run_id, body, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/apis/v2beta1/runs/{run_id}:reportMetrics', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
