...
class RecurringRunServiceApi(object):
    ...
    def create_recurring_run(self, body, **kwargs):  # noqa: E501
        """Creates a new recurring run in an experiment, given the experiment ID. If the experiment ID is not specified, create the recurring run in the default experiment.  # noqa: E501
    ...
    def create_recurring_run_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiRecurringRun, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='ApiRecurringRun',  # noqa: E501
    ...
    def list_recurring_runs(self, **kwargs):  # noqa: E501
        """Find all recurring runs in the experiment given the experiment id.  If experiment ID is not specified, find all recurring runs across all experiments.  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ApiListRecurringRunsResponse
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_recurring_runs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiListRecurringRunsResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ApiListRecurringRunsResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
