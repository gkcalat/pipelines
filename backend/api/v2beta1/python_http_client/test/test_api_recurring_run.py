...
from kfp_server_api.models.api_recurring_run import ApiRecurringRun  # noqa: E501
from kfp_server_api.rest import ApiException

class TestApiRecurringRun(unittest.TestCase):
    """ApiRecurringRun unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ApiRecurringRun
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = kfp_server_api.models.api_recurring_run.ApiRecurringRun()  # noqa: E501
        if include_optional :
