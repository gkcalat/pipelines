...
type APIPipelineTaskDetail struct {
	...
	Execution *MlMetadataExecution `json:"execution,omitempty"`
	...
	Inputs map[string]PipelineTaskDetailArtifactList `json:"inputs,omitempty"`

	// The runtime output artifacts of the task.
	Outputs map[string]PipelineTaskDetailArtifactList `json:"outputs,omitempty"`
	...
	// over time.
	StateHistory []*PipelineTaskDetailPipelineTaskStatus `json:"state_history"`
...
func (m *APIPipelineTaskDetail) validateExecution(formats strfmt.Registry) error {
